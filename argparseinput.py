...
def arginput():
    ...
    parser.add_argument("-mGC", type=float, action="store", metavar="Minimum GC content", default=40)
    parser.add_argument("-MGC", type=float, action="store", metavar="Maximum GC content", default=60)
